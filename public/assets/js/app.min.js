!(function (t) {
    ...
    (e.prototype._reset = function () {
        ...
        (e.prototype.initMenu = function () {
            var e,
                a = this;
            this._reset(),
                t(document).on("click", ".button-menu-mobile", function (t) {
                ...
                t(".side-nav").length &&
                ((e = t(".side-nav li .collapse")),
                    t(".side-nav li [data-bs-toggle='collapse']").on("click", function (t) {
                        return !1;
                    }),
                    e.on({
                    ...
                    t(".side-nav a").each(function () {
                        ...
                        this.href == i &&
                            (t(this).addClass("active"),
                                t(this).parent().addClass("menuitem-active"),
                                t(this).parent().parent().parent().addClass("show"),
                                t(this).parent().parent().parent().parent().addClass("menuitem-active"),
                                "sidebar-menu" !== (e = t(this).parent().parent().parent().parent().parent().parent()).attr("id") && e.addClass("show"),
                                t(this).parent().parent().parent().parent().parent().parent().parent().addClass("menuitem-active"),
                                "wrapper" !== (a = t(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr("id") && a.addClass("show"),
                                (o = t(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || o.addClass("menuitem-active"));
                    }));
            var o = document.querySelectorAll("ul.navbar-nav .dropdown .dropdown-toggle"),
                i = !1;
            o.forEach(function (t) {
                t.addEventListener("click", function (e) {
                    var a;
                    t.parentElement.classList.contains("nav-item") ||
                        ((i = !0),
                            (a = t.parentElement.parentElement.parentElement.querySelector(".nav-link")),
                            bootstrap.Dropdown.getInstance(a).show(),
                            t.ariaExpanded ? bootstrap.Dropdown.getInstance(t).hide() : bootstrap.Dropdown.getInstance(a).show(),
                            (i = !0));
                }),
    ...
    (function (t) {
        ...
        (e.prototype._selectOptionsFromConfig = function () {
            ...
            if (e) {
                switch ((t("input[type=checkbox]").prop("checked", !1), e.sideBarTheme)) {
                    case "default":
                ...
                e.isBoxed ? t("#boxed-check").prop("checked", !0) : t("#fluid-check").prop("checked", !0),
                    e.isCondensed && t("#condensed-check").prop("checked", !0),
                    e.isScrollable && t("#scrollable-check").prop("checked", !0),
                    e.isScrollable || e.isCondensed || t("#fixed-check").prop("checked", !0),
                    e.isDarkModeEnabled || (t("#light-mode-check").prop("checked", !0), "vertical" === e.layout && t("input[type=checkbox][name=theme]").prop("disabled", !1)),
                    e.isDarkModeEnabled && (t("#dark-mode-check").prop("checked", !0), "vertical" === e.layout && t("input[type=checkbox][name=theme]").prop("disabled", !1));
            }
        }),
            ...
            (e.prototype.init = function () {
                ...
                t(document).on("click", ".end-bar-toggle", function () {
                    ...
                    t(document).on("click", "body", function (e) {
                        0 < t(e.target).closest(".end-bar-toggle, .end-bar").length ||
                            0 < t(e.target).closest(".leftside-menu, .side-nav").length ||
                            t(e.target).hasClass("button-menu-mobile") ||
                            0 < t(e.target).closest(".button-menu-mobile").length ||
                            (t("body").removeClass("end-bar-enabled"), t("body").removeClass("sidebar-enable"));
                    }),
                    ...
                    t("#resetBtn").on("click", function (a) {
                        a.preventDefault(),
                            t.App.resetLayout(function () {
                                e._selectOptionsFromConfig();
                            });
                    });
            }),
            (t.RightBar = new e()),
            (t.RightBar.Constructor = e);
    })(window.jQuery),
    (function (t) {
        "use strict";
        function e() {
        ...
        (e.prototype._saveConfig = function (e) {
            ...
            (e.prototype._applyConfig = function () {
                ...
                e._config.isDarkModeEnabled ? e.activateDarkMode() : e.deactivateDarkMode(),
                    e._config.isBoxed && e.activateBoxed(),
                    e._config.isCondensed && e.activateCondensedSidebar(),
                    e._config.isScrollable && e.activateScrollableSidebar();
            }),
            ...
            (e.prototype.activateDarkMode = function () {
                ...
                this.body.css("visibility", "hidden"),
                    t("#light-style").attr("disabled", !0),
                    t("#dark-style").removeAttr("disabled"),
                    setTimeout(function () {
                        e.body.css("visibility", "visible");
                    }, 500),
                    t.LeftSidebar.activateDarkTheme(),
                    this._saveConfig({ isDarkModeEnabled: !0, sideBarTheme: i });
            }),
            (e.prototype.deactivateDarkMode = function () {
                var e = this;
                this.body.css("visibility", "hidden"),
                    t("#dark-style").attr("disabled", !0),
                    t("#light-style").removeAttr("disabled"),
                    setTimeout(function () {
                        e.body.css("visibility", "visible");
                    }, 500),
            ...
            (e.prototype.init = function () {
                var e = this;
                t("#main-style-container").length && (e.defaultSelectedStyle = t("#main-style-container").attr("href")),
                    this._applyConfig(),
                    this._adjustLayout(),
            ...
            (t.LayoutThemeApp = new e()),
            (t.LayoutThemeApp.Constructor = e);
    })(window.jQuery),
    (function (t) {
        "use strict";
        function e() {
    ...
    (function (t) {
        ...
        (e.prototype.initSelect2 = function () {
            ...
            (e.prototype.initMaxlength = function () {
                var e = { warningClass: "badge bg-success", limitReachedClass: "badge bg-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", placement: "bottom" };
    ...
    (function (t) {
        ...
        (e.prototype.initTooltipPlugin = function () {
            ...
            (e.prototype.initPopoverPlugin = function () {
                t.fn.popover &&
                    t('[data-bs-toggle="popover"]').each(function (e, a) {
                        t(this).popover();
                    });
            }),
            ...
            (e.prototype.initShowHidePassword = function () {
                t("[data-password]").on("click", function () {
                    "false" == t(this).attr("data-password")
                        ? (t(this).siblings("input").attr("type", "text"), t(this).attr("data-password", "true"), t(this).addClass("show-password"))
                        : (t(this).siblings("input").attr("type", "password"), t(this).attr("data-password", "false"), t(this).removeClass("show-password"));
                });
            }),
        ...
        (e.prototype.activateDefaultSidebarTheme = function () {
            ...
            (e.prototype.init = function () {
                ...
                window.sessionStorage &&
                    e &&
                    e.hasOwnProperty("showRightSidebarOnStart") &&
                    e.showRightSidebarOnStart &&
                    (sessionStorage.getItem("_HYPER_VISITED_") || (t.RightBar.toggleRightSideBar(), sessionStorage.setItem("_HYPER_VISITED_", !0))),
                    t.Portlet.init(),
